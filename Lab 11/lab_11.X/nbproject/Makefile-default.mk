...
SOURCEFILES_QUOTED_IF_SPACED=Interrupt.c I2C_Support.c I2C_Soft.c lab_11_main.c Main_Screen.c ST7735_TFT.c utils.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/lab_11_main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/utils.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/I2C_Soft.p1.d ${OBJECTDIR}/lab_11_main.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/ST7735_TFT.p1.d ${OBJECTDIR}/utils.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/lab_11_main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/utils.p1

# Source Files
SOURCEFILES=Interrupt.c I2C_Support.c I2C_Soft.c lab_11_main.c Main_Screen.c ST7735_TFT.c utils.c
...
${OBJECTDIR}/lab_11_main.p1: lab_11_main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab_11_main.p1.d 
	@${RM} ${OBJECTDIR}/lab_11_main.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,-config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/lab_11_main.p1 lab_11_main.c 
	@-${MV} ${OBJECTDIR}/lab_11_main.d ${OBJECTDIR}/lab_11_main.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/lab_11_main.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
