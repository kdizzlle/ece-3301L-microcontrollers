...
#define TFT_DC      PORTDbits.RD2       // Location of TFT D/C
#define TFT_CS      PORTDbits.RD3       // Location of TFT Chip Select
#define TFT_RST     PORTDbits.RD4       // Location of TFT Reset
